        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentTurnTeam = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameUsers_AspNetUsers_IdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamScores_GameUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "GameUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamScores_Sessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsedHelps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsedHelps_GameUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "GameUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsedHelps_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamAnswered = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserUsedQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserUsedQuestions_GameUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "GameUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserUsedQuestions_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameUsers_Email",
                table: "GameUsers",
                column: "Email");

            migrationBuilder.CreateIndex(
                name: "IX_GameUsers_IdentityUserId",
                table: "GameUsers",
                column: "IdentityUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GameUsers_Username",
                table: "GameUsers",
                column: "Username",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamScores_SessionId",
                table: "TeamScores",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamScores_UserId",
                table: "TeamScores",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsedHelps_SessionId",
                table: "UsedHelps",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_UsedHelps_UserId",
                table: "UsedHelps",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserUsedQuestions_QuestionId",
                table: "UserUsedQuestions",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserUsedQuestions_UserId",
                table: "UserUsedQuestions",
                column: "UserId");
        }
